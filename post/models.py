...
class RecruitmentProgressStatus(models.Model):
...
class JobPost(models.Model):
    ...
    status = models.ForeignKey(RecruitmentProgressStatus, on_delete=models.SET_NULL, null=True)
...
class RecruitmentProgressStatusLog(models.Model):
    user = models.ForeignKey(User, on_delete=models.CASCADE)
    post = models.ForeignKey(JobPost, on_delete=models.CASCADE)
    changed_status = models.ForeignKey(RecruitmentProgressStatus, on_delete=models.SET_NULL, null=True)
